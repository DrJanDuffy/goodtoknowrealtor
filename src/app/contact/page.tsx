        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-amber-100 leading-relaxed">
              Ready to start your Las Vegas real estate journey? I'm here to help you achieve your property goals with personalized service and expert guidance.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Call Me Directly</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Text Message</h3>
              <p className="text-gray-600 mb-6">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Dr. Janet Duffy Real Estate</p>
                      <p className="text-gray-600">Las Vegas, Nevada</p>
                      <p className="text-gray-600">Serving all Las Vegas Valley communities</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Email: janet@goodtoknowrealtor.com</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Downtown Las Vegas</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Southwest Valley</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">All Las Vegas Valley</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-amber-600 to-yellow-600 text-white">
        <div className="container text-center">
          ...
          <p className="text-xl text-amber-100 mb-8 max-w-3xl mx-auto">
            For urgent real estate matters or time-sensitive transactions, don't hesitate to call me directly.
          </p>
